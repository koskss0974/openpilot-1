...
class SteerLimitParams:
  STEER_MAX = 385   # 409 is the max, 255 is stock
  STEER_DELTA_UP = 3
  STEER_DELTA_DOWN = 7
...
class CAR:
  ...
  CEED = "KIA CEED 2019"
  CARDENZA = "KIA K7 2016-2019"
  CARDENZA_HEV = "KIA K7 HEV 2016-2019"
...
FEATURES = {
  ...
  "use_cluster_gears": set([CAR.ELANTRA, CAR.KONA, CAR.ELANTRA_GT_I30, CAR.CARDENZA, CAR.GRANDEUR]),     
  ...
  "use_elect_gears": set([CAR.OPTIMA_HEV, CAR.IONIQ_EV_LTD, CAR.KONA_EV, CAR.SONATA_HEV, CAR.NIRO_EV, CAR.NIRO_HEV, CAR.CARDENZA_HEV, CAR.GRANDEUR_HEV]),
  # Use E_EMS11 Message for Gas and Brake for Hybrid/ELectric
  "use_elect_ems": set([CAR.OPTIMA_HEV, CAR.IONIQ_EV_LTD, CAR.KONA_EV, CAR.SONATA_HEV, CAR.NIRO_EV, CAR.NIRO_HEV, CAR.CARDENZA_HEV, CAR.GRANDEUR_HEV]),
  # send LFA MFA message for new HKG models
  "send_lfa_mfa": set([CAR.SONATA, CAR.PALISADE, CAR.SONATA_HEV, CAR.SANTA_FE, CAR.NIRO_EV]),
  "has_scc13": set([]), 
  "has_scc14": set([]), 
  # these cars use the FCA11 message for the AEB and FCW signals, all others use SCC12
  "use_fca": set([CAR.SONATA, CAR.ELANTRA, CAR.ELANTRA_GT_I30, CAR.STINGER, CAR.IONIQ, CAR.KONA, CAR.KONA_EV, CAR.FORTE, CAR.PALISADE, CAR.GENESIS_G70]),
...
DBC = {
  ...
  CAR.CARDENZA: dbc_dict('hyundai_kia_generic', None),
  CAR.CARDENZA_HEV: dbc_dict('hyundai_kia_generic', None),
}
